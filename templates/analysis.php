        ...
        <div class="row">
            ...
            <div class="container">
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <h4><?php echo file_get_contents("User".$_COOKIE['login_user'].".txt") ?></h4>
                </div>
          ...
          <div class="col s12 m4">
            <div class="container">
              <div class="card">
                <div class="card-content">
                    <img src="../static/img/instagram.png" width="150" height="150">
          ...
          <div class="col s12 m4">
            <div class="container">
              <div class="card">
                ...
                <div class="card-content">
                    <img src="../static/img/website.png" width="150" height="150">
          ...
          <div class="col s12 m4">
            <div class="container">
              <div class="card">
                ...
                <div class="card-content">
                    <img src="../static/img/youtube.png" width="150" height="150">
                  <h5><b>Youtube</b></h5><br>
                  <p>Go make a Youtube account!</p>
                  <span>Overall Score:</span>
                  <h4>100</h4>
                </div>
